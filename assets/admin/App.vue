<script setup>
import Logo from '../../movebender.svg';
</script>

<template>
    <div>
        <div class="movebender-main rel">
            <header id="movebender-header" class="flex sticky align-items:center bg:white px:20 py:6 top:$(wp-admin--admin-bar--height) z:12">
                            ...
                            <template #popper>
                                <div>
                                    <div role="group" class="flex flex:column font:14 min-w:120 p:4 w:auto">
                                        <a href="https://movebender.yabe.land/docs?utm_source=wordpress-plugins&utm_medium=plugin-menu&utm_campaign=yabe-movebender&utm_id=pro-version" target="_blank" class="flex align-items:center bg:white bg:gray-10:hover box-shadow:none:focus cursor:pointer fg:gray-90 gap:10 px:10 py:6 r:4 text:none user-select:none">
            ...
            <div class="mx:auto p:0">
                ...
                <div class="movebender-notice-pool b:0 mx:0">
                    <hr class="wp-header-end">
                    <!-- <WordpressNotice /> -->
                </div>

                <div class="movebender-content my:20 px:20">
                    ...
                    <ul>
                        ...
                        <li><a href="https://github.com/orgrosua/yabe-movebender/issues" target="_blank">Feature request / Report a bug</a></li>
                        <li><a href="https://github.com/orgrosua/yabe-movebender/discussions" target="_blank">Discussion</a></li>
