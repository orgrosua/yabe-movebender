...
namespace Yabe\Movebender\Module;
...
class Loader
{
    ...
    public function scan_modules()
    {
         ...
         */
        do_action('a!yabe/movebender/module/integration:before_scan', $finder);
    ...
    public function register_modules(): void
    {
        ...
        $modules = apply_filters('f!yabe/movebender/module/integration:register_modules', $this->modules);
