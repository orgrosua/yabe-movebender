...
class Config
{
    ...
    {
        $options = json_decode(get_option(MOVEBENDER::WP_OPTION . '_options', '{}'), null, 512, JSON_THROW_ON_ERROR);

        $options = apply_filters('f!yabe/movebender/api/setting/option:index_options', $options);
    ...
    public static function set($path, $value)
    {
        ...
        update_option(MOVEBENDER::WP_OPTION . '_options', wp_json_encode($options, JSON_THROW_ON_ERROR));
    }
}
